...
function Todos() {
  ...
  return (
    <div className="todos-container">
      ...
      <h1 className="create-task-heading">Create <span className="create-task-heading-subpart">
       Task</span></h1>
      <input type="text" 
      ...
      {edit.isEdited?<button type="submit" className="button" onClick={onClickUpdate} >Upadate</button>:
      <button type="submit" className="button" onClick={onAddTodo}>Add</button>}
    <div>
    <h1 className="create-task-heading-subpart">Category</h1>
      <select value={filteredData} 
